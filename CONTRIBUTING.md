...
This repository follows conventional commits, dogfoods its own Prettier config, and lints with the shared ESLint config.

## Local setup

```bash
git clone git@github.com:leandromatos/prettier-config.git
cd prettier-config
pnpm install
```
